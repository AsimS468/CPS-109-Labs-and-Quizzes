...
n = int(input())
n = n-1 #The value for n represents the index after the intended instance of the Fibonacci sequence

Fn = (((2 + GR) / 5) * math.pow(GR, n)) + (((3 - GR) / 5) * math.pow(GR, -n))
print("The nth fibonacci number is " + str(Fn) + ".")
